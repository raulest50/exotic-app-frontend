...
export interface BorderGlowProps {
  children?: ReactNode;
  className?: string;
  /** Se fusiona al final del estilo del nodo raíz (p. ej. flex / width en layouts padre). */
  style?: CSSProperties;
  edgeSensitivity?: number;
  glowColor?: string;
  backgroundColor?: string;
  borderRadius?: number;
  /** Grosor del trazo del borde (px), capas ::before/::after y borde base. */
  borderWidth?: number;
  glowRadius?: number;
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  const cardStyle: CSSProperties = {
    ...
    ['--card-border-width' as string]: `${borderWidth}px`,
    ...
    ['--fill-opacity' as string]: String(fillOpacity),
    ...style,
  };
