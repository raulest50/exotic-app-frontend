...
interface SinInsumosStep3EjecutarProps {
...
export default function SinInsumosStep3Ejecutar({
    setActiveStep,
    excelFile,
    onSuccess,
}: SinInsumosStep3EjecutarProps) {
        ...
        try {
            ...
            if (!result.valid && result.errors && result.errors.length > 0) {
                ...
                toast({
                    ...
                    description: `Se registraron ${successCount} terminado(s) correctamente.`,
                    status: "success",
                    duration: 5000,
                    isClosable: true,
                });
        ...
        return (
            ...
            >
                ...
                <Text fontFamily="Comfortaa Variable" color="green.900">
                    Los terminados se registraron correctamente en la base de datos (sin insumos ni proceso).
                </Text>
                <RiSave3Fill
                    style={{
                        width: "10em",
        ...
        <Box p={4}>
            <VStack align="stretch" spacing={6}>
                ...
                <Box p={5} borderWidth="1px" borderRadius="lg">
                    <Text mb={4}>
                        Se procesará el archivo Excel y se registrarán los terminados en la base de datos (sin insumos ni proceso de producción).
                    </Text>
