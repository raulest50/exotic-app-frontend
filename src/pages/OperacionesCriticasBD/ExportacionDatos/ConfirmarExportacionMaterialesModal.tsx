...
interface ConfirmarExportacionMaterialesModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm?: () => void;
}

export default function ConfirmarExportacionMaterialesModal({
    isOpen,
    onClose,
    onConfirm,
}: ConfirmarExportacionMaterialesModalProps) {
    ...
    const handleExportar = async () => {
        ...
        setIsExporting(true);
        try {
            const response = await axios.get(endpoints.exportacion_materiales_excel, {
            ...
            let filename = "exportacion_materiales.xlsx";
            ...
            toast({
                ...
                description: "El archivo Excel de materiales se ha descargado correctamente.",
                status: "success",
                duration: 5000,
                isClosable: true,
            });
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} isCentered>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader>Confirmar exportación de materiales</ModalHeader>
