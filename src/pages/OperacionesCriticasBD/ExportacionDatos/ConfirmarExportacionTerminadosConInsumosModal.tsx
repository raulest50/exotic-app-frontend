...
interface ConfirmarExportacionTerminadosConInsumosModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm?: () => void;
}

export default function ConfirmarExportacionTerminadosConInsumosModal({
    isOpen,
    onClose,
    onConfirm,
}: ConfirmarExportacionTerminadosConInsumosModalProps) {
    ...
    const handleExportar = async () => {
        ...
        setIsExporting(true);
        try {
            const response = await axios.get(endpoints.exportacion_terminados_json_con_insumos, {
            ...
            let filename = "exportacion_terminados_con_insumos.json";
            ...
            toast({
                ...
                description: "El archivo JSON de productos terminados con insumos se ha descargado correctamente.",
                status: "success",
                duration: 5000,
                isClosable: true,
            });
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} isCentered>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader>Confirmar exportación de terminados con insumos</ModalHeader>
