...
export default function DispensacionAdicionalStep2ReviewSubmit({
    ...
    const handleRegistrarDispensacion = async () => {
        ...
        try {
            ...
            toast({
                title: 'Éxito',
                description: 'Dispensación adicional registrada correctamente',
                status: 'success',
                duration: 3000,
                isClosable: true
            });

            // Llamar al callback si existe, o reiniciar
            if (onComplete) {
                setTimeout(() => {
                    onComplete();
                }, 1500);
    ...
    return (
        <Box p='1em' bg='orange.50' minH='100vh'>
            <Flex direction='column' gap={6} maxW='container.xl' mx='auto'>
                <Heading fontFamily='Comfortaa Variable' textAlign='center' color='orange.700'>
                    Revisar y Registrar Dispensación Adicional
                </Heading>
                ...
                <Box bg='white' p={4} borderRadius='md' boxShadow='sm'>
                    <Heading size='md' mb={4} fontFamily='Comfortaa Variable'>
                        Resumen de Materiales Adicionales a Dispensar
                    </Heading>
                ...
                <Flex gap={4} justify='flex-end'>
                    ...
                    >
                        Registrar Dispensación Adicional
                    </Button>
                </Flex>
            </Flex>
