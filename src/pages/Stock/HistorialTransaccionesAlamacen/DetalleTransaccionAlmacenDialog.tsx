...
import { TransaccionAlmacenRow, TIPO_ENTIDAD_CAUSANTE_LABELS } from './types';
import { MovimientoDetalle } from '../../TransaccionesAlmacen/types';

interface DetalleTransaccionAlmacenDialogProps {
    isOpen: boolean;
    onClose: () => void;
    transaccion: TransaccionAlmacenRow | null;
}
...
export default function DetalleTransaccionAlmacenDialog({
    isOpen,
    onClose,
    transaccion,
}: DetalleTransaccionAlmacenDialogProps) {
    ...
    const tipoLabel = TIPO_ENTIDAD_CAUSANTE_LABELS[transaccion.tipoEntidadCausante] || transaccion.tipoEntidadCausante;
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="4xl" isCentered>
            ...
            <ModalContent>
                <ModalHeader fontFamily="Comfortaa Variable">
                    Detalle de Transacción de Almacén
                </ModalHeader>
                <ModalCloseButton />
                <ModalBody>
                        ...
                        <Box>
                            ...
                            {transaccion.usuarioAprobador && (
                                <Box mt={2}>
                                    ...
                                    <Text fontSize="sm">
                                        {transaccion.usuarioAprobador.nombre || `ID: ${transaccion.usuarioAprobador.userId}`}
                                    </Text>
                                </Box>
                            )}
                        </Box>
